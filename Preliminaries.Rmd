...
* The course pages use 'code-folding' - at the top of the page you have the option to show all code, but ideally you will unfold code to run each section and in many sections try on your own prior to undolfing the code chunk to see thesolution.
