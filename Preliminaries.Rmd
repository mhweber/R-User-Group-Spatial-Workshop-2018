...
If EPA folks have any trouble with installing the CRAN version of `mapview` with the agency current version of R (3.4.3) you can try using `devtools` to install the prior CRAN binary package of `mapview` described [here](https://support.rstudio.com/hc/en-us/articles/219949047-Installing-older-versions-of-packages) and using prior binary of `mapview` (2.4.0) describe [here](https://cran.r-project.org/web/packages/mapview/).
