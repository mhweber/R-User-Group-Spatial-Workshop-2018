...
Notice the different output now on typing r?  And we can plot now as well with base R `plot`:
...
[main source](https://geocompr.robinlovelace.net/read-write.html)
[another source](https://pakillo.github.io/R-GIS-tutorial/)
