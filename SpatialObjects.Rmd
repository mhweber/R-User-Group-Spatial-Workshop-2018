...
```{r cities, message=FALSE, warning=FALSE}
...
```{r cities2, message=FALSE, warning=FALSE}
cities <- c('Ashland','Corvallis','Bend','Portland','Newport')
longitude <- c(-122.699, -123.275, -121.313, -122.670, -124.054)
latitude <- c(42.189, 44.57, 44.061, 45.523, 44.652)
population <- c(20062,50297,61362,537557,9603)
...
```{r spatial class, message=FALSE, warning=FALSE}
library(sp)
getClass("Spatial")
```
...
```{r example spatial, message=FALSE, warning=FALSE}
cities <- c('Ashland','Corvallis','Bend','Portland','Newport')
longitude <- c(-122.699, -123.275, -121.313, -122.670, -124.054)
latitude <- c(42.189, 44.57, 44.061, 45.523, 44.652)
population <- c(20062,50297,61362,537557,9603)
...
```{r plot spatial, message=FALSE, warning=FALSE}
library(maptools)
plot(pts, axes=T)
...
```{r st, message=FALSE, warning=FALSE}
str(pts)
```
...
```{r bbox, message=FALSE, warning=FALSE}
pts@bbox
```

Or you can use the method directly:
```{r bbox2, message=FALSE, warning=FALSE}
bbox(pts)
```
...
```{r CRS, message=FALSE, warning=FALSE}
...
```{r CRS2, message=FALSE, warning=FALSE}
